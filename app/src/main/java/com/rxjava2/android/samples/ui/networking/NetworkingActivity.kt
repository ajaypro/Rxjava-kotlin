...
import com.rxjava2.android.samples.ui.networking.NetworkingActivity.Companion.TAG
        ...
        Rx2AndroidNetworking.get("https://fierce-cove-29863.herokuapp.com/getAnUser/{userId}")
                ...
                .subscribe(object : Observer<User> {
                    ...
                    override fun onNext(user: User) {
                        ...
                        textView.append(user.id.toString())
                        textView.append(user.firstname + user.lastname)
                        textView.append(user.isFollowing.toString())
                    }
